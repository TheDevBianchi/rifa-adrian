      ...
      {raffle.randomTickets ? (
        <div className='space-y-4'>
          ...
          <div className='grid grid-cols-2 gap-2'>
            {/* Agregar botones para incrementar tickets 3,5,10,15,20,50,100 */}
            <Button className={'bg-amber-500 hover:bg-amber-500/30'} type='button' onClick={() => setRandomTicketCount(3)}>
              +3 Tickets
            </Button>
            <Button className={'bg-amber-500 hover:bg-amber-500/30'} type='button' onClick={() => setRandomTicketCount(5)}>
              +5 Tickets
            </Button>
            <Button className={'bg-amber-500 hover:bg-amber-500/30'} type='button' onClick={() => setRandomTicketCount(10)}>
              +10 Tickets
            </Button>
            <Button className={'bg-amber-500 hover:bg-amber-500/30'} type='button' onClick={() => setRandomTicketCount(15)}>
              +15 Tickets
            </Button>
            <Button className={'bg-amber-500 hover:bg-amber-500/30'} type='button' onClick={() => setRandomTicketCount(20)}>
              +20 Tickets
            </Button>
            <Button className={'bg-amber-500 hover:bg-amber-500/30'} type='button' onClick={() => setRandomTicketCount(50)}>
              +50 Tickets
            </Button>
            <Button className={'bg-amber-500 hover:bg-amber-500/30'} type='button' onClick={() => setRandomTicketCount(100)}>
              +100 Tickets
            </Button>
          </div>
            ...
            <div className='mt-4 pt-4 border-t border-gray-700'>
              <div className='flex justify-between items-center mb-3'>
                ...
                {selectedPromotion ? (
                  ...
                  <span className="text-xs text-gray-400 italic">Haz clic para seleccionar una</span>
                )}
              </div>
