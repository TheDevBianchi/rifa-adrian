    ...
    <div className='container mx-auto p-4 md:p-6 space-y-6 md:space-y-8'>
      ...
      <div className='flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4 lg:gap-0'>
        ...
        <Button
          ...
          className='w-full md:w-auto bg-primary hover:bg-primary/90 text-[#222222] px-4 py-2 rounded-lg transition-all duration-200 flex items-center justify-center md:justify-start gap-2 shadow-lg shadow-primary/25'
        >
